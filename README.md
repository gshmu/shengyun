...
**开发状态**：✅ v1.0.2 稳定版 - 修复 ün/üan 互补分布规则，零声母层完善
...
| **韵母层** | a, o, e, i, u, ü, ai, ei, ao, ou, ia, ie, iao, iu, ua, uo, uai, ui, üe, er, an, en, in, un, ün, üan, ang, eng, ing, ong, ian, uan, iang, uang, iong 等 | 39个 |
...
| 张 | zhang | zh + ang | 2次 |
| 居 | ju | j + ü（显示ü，发ü音） | 2次 |
| 军 | jun | j + ün（显示ün，发ün音） | 2次 |
| 学 | xue | x + üe（显示üe，发üe音） | 2次 |
...
### v1.0.2 (2025-11-16)
- ✅ 修复 ün/üan 互补分布规则
- ✅ 实现正确的韵母如实显示：j/q/x/y 层显示 ü/ün/üe/üan
- ✅ 修正 l/n 的韵母屏蔽（移除不存在的组合）
- ✅ 完善零声母韵母层（shengyun_finals_zero）
- ✅ 完善韵母层生成脚本（同时生成 24+2 层）

### v1.0.1 (2025-11-16)
- ✅ 修复关键声韵组合缺失（l+iang, n+iang 等）
- ✅ 更新 author 信息
